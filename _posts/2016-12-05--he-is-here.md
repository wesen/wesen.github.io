...
![level macro](../figs/heishere/he-is-here-level.png)
...
![control value scaling](../figs/heishere/blocks-scaling.png)
...
![envelope follower](../figs/heishere/blocks-env-follower.png)
...
![input wave](../figs/heishere/blocks-env-follower-inputwave.png)
...
![input wave](../figs/heishere/he-is-here-env-follower.gif)
...
![input wave 2](../figs/heishere/blocks-env-follower-inputwave2.png)
...
![level macro output](../figs/heishere/blocks-env-follower-output.png)
...
![core asym computation](../figs/heishere/blocks-asym-computation.png)

And here is the delay length computation:

![core delay length computation](../figs/heishere/blocks-delay-length-computation.png)

And we are almost done, the only missing part is the actual delay line, which is built using available library core cells.

![core delay line](../figs/heishere/blocks-delay-line.png)
